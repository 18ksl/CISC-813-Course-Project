(define (domain robotGreeter)
    ...
    (:predicates
        ...
        (bye ?v - visitor) ; robot has ended interaction with visitor
    ...
    (:action guideVisitor ; robot brings visitor to office of desired lab member or to desired location 
        ...
        :effect (and
                ...
                ; robot moves visitor to desired location
    ...
    (:action dropoff ; robot drops visitor off at meeting or desired location
...
;     (:action reset ; action to reset system if greeter framework wanted to be run on a loop
